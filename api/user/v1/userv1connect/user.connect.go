...
const (
	...
	UserGetProcedure = "/user.v1.User/Get"
)

// UserClient is a client for the user.v1.User service.
type UserClient interface {
	Get(context.Context, *connect.Request[v1.GetRequest]) (*connect.Response[v1.GetResponse], error)
}

// NewUserClient constructs a client for the user.v1.User service. By default, it uses the Connect
...
func NewUserClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) UserClient {
	...
	userMethods := v1.File_api_user_v1_user_proto.Services().ByName("User").Methods()
	return &userClient{
...
// Get calls user.v1.User.Get.
func (c *userClient) Get(ctx context.Context, req *connect.Request[v1.GetRequest]) (*connect.Response[v1.GetResponse], error) {
	return c.get.CallUnary(ctx, req)
}

// UserHandler is an implementation of the user.v1.User service.
...
func (UnimplementedUserHandler) Get(context.Context, *connect.Request[v1.GetRequest]) (*connect.Response[v1.GetResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("user.v1.User.Get is not implemented"))
}

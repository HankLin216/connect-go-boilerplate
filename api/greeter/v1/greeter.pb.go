...
const file_api_greeter_v1_greeter_proto_rawDesc = "" +
	...
	"\aGreeter\x12A\n" +
	"\bSayHello\x12\x18.greeter.v1.HelloRequest\x1a\x19.greeter.v1.HelloResponse\"\x00B\xae\x01\n" +
	"\x0ecom.greeter.v1B\fGreeterProtoP\x01ZEgithub.com/HankLin216/connect-go-boilerplate/api/greeter/v1;greeterv1\xa2\x02\x03GXX\xaa\x02\n" +
	"Greeter.V1\xca\x02\n" +
